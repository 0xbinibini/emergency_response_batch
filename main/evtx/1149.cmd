...
rem || ..\..\tools\Logparser\LogParser.exe -i:evt -o:DATAGRID "select TimeGenerated,EventID,EventType,Strings,ComputerName,extract_token(strings,2,'|')  as 源IP,SID from '%arg%\Microsoft-Windows-TerminalServices-LocalSessionManager Operational.evtx' where eventid=1149 %sqltime%"
